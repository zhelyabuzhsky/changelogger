...
class MyProjectsViewTests(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='jacob', email='jacob@mail.com', password='top_secret')
    ...
    def test_success(self):
        project_django = Project.objects.create(title="django", url="https://github.com/django/django")
